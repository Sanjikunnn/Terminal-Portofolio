...
export default function App() {
  ...
  useEffect(() => {
    ...
    // **Cleanup function untuk mencegah multiple listeners**
    return () => {
      term.offData(handleData);
    };
  }, [term]); // Cukup bergantung pada `term`
  ...
  const playEnterSound = () => playAudio("https://www.myinstants.com/media/sounds/akh.mp3");
